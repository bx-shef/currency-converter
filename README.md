...
| `NUXT_PUBLIC_MARKETPLACE_URL` | — | Ссылка на приложение в Маркете Bitrix24 (карточка «Приложение для Bitrix24» под калькулятором). Пусто → карточка скрыта (ссылку не выдумываем). |
...
| `NUXT_PUBLIC_MARKETPLACE_URL` | Ссылка на приложение в Маркете Bitrix24 (карточка под калькулятором; необязательно). Пусто → карточка скрыта. |
